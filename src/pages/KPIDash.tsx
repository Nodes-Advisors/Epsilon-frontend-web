      ...
      <div style={{ display: 'flex', gap: '2rem' }}>
        ...
        <div style={{  display: 'flex', flexDirection: 'column', gap: '3rem', position: 'relative' }} >
          <div style={{ display: 'flex', gap: '1rem', 
            ...
            <button className={focused === 'all' ? styles['kpi-option-highlighted'] : styles['kpi-option']} onClick={() => setFocused('all')} >All</button>
            <button className={focused === 'you' ? styles['kpi-option-highlighted'] : styles['kpi-option']} onClick={() => setFocused('you')} >You</button>
