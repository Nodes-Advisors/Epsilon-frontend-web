...
export default function KPIDash() {
  ...
  const [timeScale, setTimeScale] = useState<'today' | 'this week' | 'last week' | 'month to date' | 'year to date'>('')
          ...
          >
            ...
            >
              ...
              <KPIText extraClass={styles['kpi-filter-text-restore']}>
                <span onClick={e=> { e.stopPropagation(); setTimeScale('') }}>Restore default</span>
              </KPIText>
              <KPIText
              ...
              <ul onClick={e => {e.stopPropagation(); setTimeScale(e.target.innerText) }} className={styles['kpi-ul']}>
                <li key="today" style={ timeScale === 'today' ? {fontWeight: 600} : {fontWeight: 400} }>today</li>
                <li key="this week" style={ timeScale === 'this week' ? {fontWeight: 600} : {fontWeight: 400} }>this week</li>
                <li key="last week" style={ timeScale === 'last week' ? {fontWeight: 600} : {fontWeight: 400} }>last week</li>
                <li key="month to date" style={ timeScale === 'month to date' ? {fontWeight: 600} : {fontWeight: 400} }>month to date</li>
                <li key="year to date" style={ timeScale === 'year to date' ? {fontWeight: 600} : {fontWeight: 400} }>year to date</li>
              </ul>
              <KPIText
                extraClass={styles['kpi-filter-text-sub']}
                fontColor="#fff"
